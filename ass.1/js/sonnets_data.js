...
This is the DATA for our program. We have an array of lines
for every "original" sonnet from Queneau's set of sonnets, of
which there are ten.

At the end, we also have an array of sonnets, containing all ten
of the sonnets in it. That array is therefore an ARRAY OF ARRAYS,
since it is an array containing sonnets, and sonnets are arrays
of lines.
...
var sonnets = [
  sonnetOne,sonnetTwo,sonnetThree,sonnetFour,sonnetFive,
  sonnetSix,sonnetSeven,sonnetEight,sonnetNine,sonnetTen
];
